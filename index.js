function simpleSlider() {
  ...
  if (slideContainer) {
    ...
    rightArrow.style.zIndex = showArrows;
    ...
    leftArrow.style.zIndex = showArrows;
    ...
    const startSlider = (type) => {
      ...
      if (active) {
        if (
          ...
          active.nextElementSibling.classList.contains('slide')
        ) {
          next = active.nextElementSibling;
        } else if (!active.nextElementSibling.classList.contains('slide')) {
